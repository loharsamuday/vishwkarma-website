<?php
// admin/idioms/add.php
session_start();
require_once '../../config/database.php';



$page_title = "Add Idiom";
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    try {
        $stmt = $pdo->prepare("INSERT INTO idioms (idiom, slug, english_meaning, hindi_meaning, explanation, example_sentence, memory_trick, synonyms, antonyms, category_id, difficulty, exam_type, meta_title, meta_description, featured, status) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
        $stmt->execute([$idiom, $slug, $english_meaning, $hindi_meaning, $explanation, $example_sentence, $memory_trick, $synonyms, $antonyms, $category_id, $difficulty, $exam_type, $meta_title, $meta_description, $featured, $status]);
        
        $_SESSION['success_msg'] = "Idiom added successfully!";
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="idiom" name="idiom" required>
                        </div>
                        <div class="mb-3">
            ...
            <div class="col-md-4">
                <div class="card mb-4">
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            <label for="exam_type" class="form-label">Exam Type (e.g. SSC, Bank)</label>
                ...
                <div class="d-grid gap-2">
                    <button type="submit" class="btn btn-primary btn-lg">Save Idiom</button>
